...
describe('tool', () => {
    ...
    describe('invoke() method', () => {
        ...
        describe('validation', () => {
            ...
            it('validates required fields', async () => {
                ...
                await expect(myTool.invoke({ name: 'John' })).rejects.toThrow();
                await expect(myTool.invoke({ email: 'invalid-email' })).rejects.toThrow();
            });
        });
    ...
    describe('instanceof checks', () => {
        it('passes instanceof Tool check and has InvokableTool methods', () => {
            ...
            expect(null instanceof Tool).toBe(false);
        });
    });
...
//# sourceMappingURL=zod-tool.test.js.map