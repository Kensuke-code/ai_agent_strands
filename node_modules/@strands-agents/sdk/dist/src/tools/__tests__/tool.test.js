    ...
    describe('stream method', () => {
        describe('with synchronous callback', () => {
            ...
            it('handles null return values correctly', async () => {
                ...
                const { result } = await collectGenerator(tool.stream(createMockContext({ name: 'nullTool', toolUseId: 'test-null', input: {} })));
                expect(result).toEqual({
                    type: 'toolResultBlock',
                    toolUseId: 'test-null',
                    status: 'success',
            ...
            it('handles undefined return values correctly', async () => {
                ...
                const { result } = await collectGenerator(tool.stream(createMockContext({ name: 'undefinedTool', toolUseId: 'test-undefined', input: {} })));
                expect(result).toEqual({
                    type: 'toolResultBlock',
            ...
            it('handles boolean return values as text content', async () => {
                ...
                const { result: trueResult } = await collectGenerator(trueTool.stream(createMockContext({ name: 'trueTool', toolUseId: 'test-true', input: {} })));
                ...
                const { result: falseResult } = await collectGenerator(falseTool.stream(createMockContext({ name: 'falseTool', toolUseId: 'test-false', input: {} })));
            ...
            it('handles number return values as text content', async () => {
                ...
                const { result } = await collectGenerator(tool.stream(createMockContext({ name: 'numberTool', toolUseId: 'test-number', input: {} })));
                expect(result).toEqual({
                    type: 'toolResultBlock',
                ...
                const { result: negativeResult } = await collectGenerator(negativeTool.stream(createMockContext({ name: 'negativeTool', toolUseId: 'test-negative', input: {} })));
            ...
            it('handles array return values as wrapped JSON content', async () => {
                ...
                const { result } = await collectGenerator(tool.stream(createMockContext({ name: 'arrayTool', toolUseId: 'test-array', input: {} })));
                expect(result).toEqual({
                    type: 'toolResultBlock',
            ...
            it('deep copies objects to prevent mutation', async () => {
                ...
                const { result } = await collectGenerator(tool.stream(createMockContext({ name: 'copyTool', toolUseId: 'test-copy', input: {} })));
            ...
            it('deep copies arrays to prevent mutation', async () => {
                ...
                const { result } = await collectGenerator(tool.stream(createMockContext({ name: 'arrayCopyTool', toolUseId: 'test-array-copy', input: {} })));
        ...
        describe('error handling', () => {
            ...
            it('returns error for circular references', async () => {
                ...
                const { result } = await collectGenerator(tool.stream(createMockContext({ name: 'circularTool', toolUseId: 'test-circular', input: {} })));
                expect(result).toEqual({
                    type: 'toolResultBlock',
            ...
            it('silently drops non-serializable values (functions)', async () => {
                ...
                const { result } = await collectGenerator(tool.stream(createMockContext({ name: 'functionTool', toolUseId: 'test-function', input: {} })));
