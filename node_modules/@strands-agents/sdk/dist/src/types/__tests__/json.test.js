...
describe('deepCopy', () => {
    ...
    describe('object values', () => {
        it('creates a deep copy of objects', () => {
            ...
            expect(copy.nested.value).toBe('test');
        });
...
describe('deepCopyWithValidation', () => {
    ...
    describe('validation errors', () => {
        it('throws JsonValidationError for functions at top level', () => {
            ...
            expect(() => deepCopyWithValidation(func, 'testValue')).toThrow('testValue contains a function which cannot be serialized');
        });
        it('throws JsonValidationError for functions in objects', () => {
            ...
            expect(() => deepCopyWithValidation(withFunction, 'testValue')).toThrow('testValue.funcProp contains a function which cannot be serialized');
        });
        it('throws JsonValidationError for functions in nested objects', () => {
            ...
            expect(() => deepCopyWithValidation(nested, 'config')).toThrow('config.level1.level2.func contains a function which cannot be serialized');
        });
        it('throws JsonValidationError for functions in arrays', () => {
            const withFunction = [1, 2, () => 'test'];
            expect(() => deepCopyWithValidation(withFunction, 'items')).toThrow(JsonValidationError);
            expect(() => deepCopyWithValidation(withFunction, 'items')).toThrow('items[2] contains a function which cannot be serialized');
        });
        it('throws JsonValidationError for symbols in objects', () => {
            ...
            expect(() => deepCopyWithValidation(withSymbol, 'testValue')).toThrow('testValue.symProp contains a symbol which cannot be serialized');
        });
        it('throws JsonValidationError for symbols in arrays', () => {
            ...
            expect(() => deepCopyWithValidation(withSymbol, 'items')).toThrow('items[2] contains a symbol which cannot be serialized');
        });
        it('throws JsonValidationError for undefined values in objects', () => {
            ...
            expect(() => deepCopyWithValidation(withUndefined, 'testValue')).toThrow('testValue.undefinedProp is undefined which cannot be serialized');
        });
        it('throws JsonValidationError for undefined values in arrays', () => {
            ...
            expect(() => deepCopyWithValidation(withUndefined, 'items')).toThrow('items[2] is undefined which cannot be serialized');
        });
    ...
    describe('context path parameter', () => {
        it('uses custom context path in error messages', () => {
            ...
            expect(() => deepCopyWithValidation(withFunction, 'initialState')).toThrow('initialState.func contains a function which cannot be serialized');
        });
        it('uses default context path when not provided', () => {
            const withFunction = {
                func: () => 'test',
            };
            expect(() => deepCopyWithValidation(withFunction)).toThrow('value.func contains a function which cannot be serialized');
        });
    });
});
