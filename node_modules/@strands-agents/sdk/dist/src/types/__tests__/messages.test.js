...
import { Message, TextBlock, ToolUseBlock, ToolResultBlock, ReasoningBlock, CachePointBlock, GuardContentBlock, JsonBlock, systemPromptFromData, } from '../messages.js';
...
describe('systemPromptFromData', () => {
    describe('when called with string', () => {
        it('returns the string unchanged', () => {
            const data = 'You are a helpful assistant';
    ...
    describe('when called with TextBlockData', () => {
        it('converts to TextBlock', () => {
            const data = [{ text: 'System prompt text' }];
            const result = systemPromptFromData(data);
    ...
    describe('when called with CachePointBlockData', () => {
        it('converts to CachePointBlock', () => {
            const data = [{ text: 'prompt' }, { cachePoint: { cacheType: 'default' } }];
            const result = systemPromptFromData(data);
    ...
    describe('when called with unknown block type', () => {
        it('throws error', () => {
            const data = [{ unknownType: { data: 'value' } }];
