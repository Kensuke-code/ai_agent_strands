...
export class MockMessageModel extends Model {
     ...
     */
    async *_generateEventsForContent(content, stopReason) {
     ...
     */
    _createTurn(turn, explicitStopReason) {
     ...
     */
    async *_generateEventsForMessage(message, stopReason) {
     ...
     */
    async *_generateEventsForBlock(block) {
        switch (block.type) {
            case 'textBlock':
...
//# sourceMappingURL=mock-message-model.js.map