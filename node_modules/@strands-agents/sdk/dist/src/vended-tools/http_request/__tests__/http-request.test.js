...
describe('httpRequest tool', () => {
    ...
    describe.each([
        { method: 'GET', status: 200, statusText: 'OK' },
        { method: 'POST', status: 201, statusText: 'Created' },
        { method: 'PUT', status: 200, statusText: 'OK' },
        { method: 'DELETE', status: 204, statusText: 'No Content' },
        { method: 'PATCH', status: 200, statusText: 'OK' },
        { method: 'HEAD', status: 200, statusText: 'OK' },
        { method: 'OPTIONS', status: 200, statusText: 'OK' },
    ...
    describe('request configuration', () => {
        it('sends request with custom headers and body', async () => {
            ...
            expect(globalThis.fetch).toHaveBeenCalledWith('https://api.example.com/users', expect.objectContaining({
                method: 'POST',
                body: '{"name":"test"}',
                headers: { 'Content-Type': 'application/json' },
            }));
    ...
    describe('HTTP status codes', () => {
        ...
        it('throws error for 3xx redirect status codes', async () => {
            ...
            await expect(httpRequest.invoke({
                method: 'GET',
    ...
    describe('error handling', () => {
        it('throws timeout error when request exceeds timeout', async () => {
            globalThis.fetch = vi.fn().mockImplementation(async (_url, _options) => new Promise((_resolve, reject) => {
...
//# sourceMappingURL=http-request.test.js.map