...
describe('AgentState', () => {
    describe('constructor', () => {
        ...
        it('throws error for function in initial state', () => {
            ...
            expect(() => new AgentState(invalidState)).toThrow('initialState.func contains a function which cannot be serialized');
        });
        it('throws error for symbol in initial state', () => {
            const sym = Symbol('test');
            const invalidState = { sym, value: 'keep' };
            expect(() => new AgentState(invalidState)).toThrow('initialState.sym contains a symbol which cannot be serialized');
        });
        it('throws error for undefined in initial state', () => {
            const invalidState = { undef: undefined, value: 'keep' };
            expect(() => new AgentState(invalidState)).toThrow('initialState.undef is undefined which cannot be serialized');
        });
        it('throws error for nested function in initial state', () => {
            const invalidState = { nested: { func: () => 'test' } };
            expect(() => new AgentState(invalidState)).toThrow('initialState.nested.func contains a function which cannot be serialized');
        });
        it('throws error for function in array in initial state', () => {
            const invalidState = { arr: [1, () => 'test', 3] };
            expect(() => new AgentState(invalidState)).toThrow('initialState.arr[1] contains a function which cannot be serialized');
        });
    });
    describe('get', () => {
