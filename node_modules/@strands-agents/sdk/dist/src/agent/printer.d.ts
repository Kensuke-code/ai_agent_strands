 ...
 */
export declare function getDefaultAppender(): (text: string) => void;
/**
 ...
 */
export declare class AgentPrinter implements Printer {
    private readonly _appender;
    private _inReasoningBlock;
    private _toolCount;
    private _needReasoningIndent;
    /**
